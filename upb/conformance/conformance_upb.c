...
int main(void) {
  ...
  _upb_DefPool_LoadDefInitEx(
      symtab,
      &third_party_protobuf_editions_golden_test_messages_proto2_editions_proto_upbdefinit,
      true);
  _upb_DefPool_LoadDefInitEx(
      symtab,
      &third_party_protobuf_editions_golden_test_messages_proto3_editions_proto_upbdefinit,
      true);
#else
